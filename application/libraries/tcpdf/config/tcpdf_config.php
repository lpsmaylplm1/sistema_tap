 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'TABLA DE APLICABILIDAD');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Comisión de Transparencia y Acceso a la Información Pública del Estado de Campeche \nwww.cotaipec.org.mx");
